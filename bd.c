...
void get_bd(void)
{
	...
	printf("cpu_count = %-12lld  vop0_count = %-12lld  video_count = %-12lld  peri_count = %-12lld  totalcount = %-12lld  ddrcount = %-12lld  total/ddr = %f\n", 
			cpu_count,vop0_count,video_count,peri_count,totalcount,ddrfreq*8,(0.0+totalcount)/(0.0+ddrfreq*8));	
}
